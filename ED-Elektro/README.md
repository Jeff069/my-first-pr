...
| [`Powerbird-Screens.md`](./Powerbird-Screens.md) | **Verifiziert aus echten Bildschirmfotos:** Systemlandschaft (Powerbird + monday), 18-Stufen-Prozess, Positionsarten, Rechenmodell, Kostenarten, Lohngruppen, Dokumentkopf — die belastbare Grundlage | Entwicklung; ersetzt die Recherche, wo sie abweicht |
